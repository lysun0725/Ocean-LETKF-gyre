...
ln -fs ../letkf_drifters_ts/params_model.f90 ./
ln -fs ../letkf/vars_model.f90 ./
ln -fs ../letkf/letkf_obs.f90 ./
ln -fs ../letkf/letkf_local.f90 ./
ln -fs ../letkf/letkf_tools.f90 ./

ln -fs ../letkf_drifters_ts/params_letkf.f90 ./
ln -fs ../letkf_drifters_ts/letkf_drifters_obs.f90 ./
ln -fs ../letkf_drifters_ts/letkf_drifters_local.f90 ./
ln -fs ../letkf_drifters_ts/letkf_drifters_tools.f90 ./
