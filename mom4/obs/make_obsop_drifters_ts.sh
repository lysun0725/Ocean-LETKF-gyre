...
$F90 $OMP $F90OPT $DEBUG_OPT $INLINE $OBJECT_FLAG params_drift_extra.f90
...
$F90 $OMP $F90OPT $DEBUG_OPT $OBJECT_FLAG $INC_NETCDF letkf_drifters_tools.f90 $LIB_NETCDF
#--
...
#--
$F90 $OMP $F90OPT $DEBUG_OPT $OBJECT_FLAG $INC_NETCDF letkf_drifters_tools.o letkf_drifters_obs.f90
$F90 $OMP $F90OPT $DEBUG_OPT $OBJECT_FLAG $INC_NETCDF letkf_drifters_tools.o letkf_drifters_local.f90 $LIB_NETCDF
$F90 $OMP $F90OPT $DEBUG_OPT $OBJECT_FLAG $INC_NETCDF letkf_drifters_tools.o obsop_drifters_ts.f90 $LIB_NETCDF
