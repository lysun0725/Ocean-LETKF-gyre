...
INTEGER,SAVE :: nobs_dr	 !(DRIFTERS)
INTEGER,SAVE :: nslots=1                  ! number of time slots for 4D-LETKF
INTEGER,SAVE :: nbslot=1 !1               !STEVE: nbslot=1 for testing for GMAO example case. Normal case is nbslot=5 ! basetime slot
REAL(r_size),SAVE :: sigma_obs=480.0d3     !720.0d3    !3x Rossby Radius of Deformation at Equ. according to Chelton
REAL(r_size),SAVE :: sigma_obs0=200.0d3   !!200.0d3   !20x Rossby Radius of Deformation at Pole, according to Chelton
...
INTEGER,PARAMETER :: nid_dobs=5      !(DRIFTERS) 3:x, y, z; 5: x, y, x, temp, salt
