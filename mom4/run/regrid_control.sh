...
work_root=/lustre/lysun/models/Ocean-LETKF-gyre1-test3/mom4/CONTROL2
orig_root=/lustre/lysun/models/Ocean-LETKF-gyre1-test3-025/mom4/CONTROL
...
do
  ...
  mkdir ${YYYYMMDDHH}
  mkdir ${YYYYMMDDHH}/CON
  mkdir ${YYYYMMDDHH}/CON/RESTART

  workdir=${work_root}/${YYYYMMDDHH}/CON/RESTART
  origdir=${orig_root}/${YYYYMMDDHH}/CON/RESTART
...
# create the input namelist for 'ocean_temp_salt'
  cat >input.nml <<!
    &regrid_nml
       ...
       src_grid = '${orig_root}/${YYYYMMDDHH}/CON/INPUT/grid_spec.nc'
