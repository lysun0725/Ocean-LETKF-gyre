...
!===============================================================================
  ...
  USE params_model
  USE params_obs
  USE letkf_drifters_obs   !LUYU: set_letkf_obs_drifters
  USE letkf_drifters_tools !LUYU: add the drifters tool
  USE letkf_drifters       !LUYU: das_drifters
...
!------------------------------------------------------------------------------
  ...
  CALL das_drifters(gues4d,gues3d,gues2d,anal4d,anal3d,anal2d)     
  WRITE(6,*) "Finish das_letkf_drifters"
